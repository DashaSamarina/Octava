		...
		<div class="row offers-row">
			<div class="col-lg-9 col-md">
				<div class="offer offer__first-block">
					...
					<div class="offer__main">Включает несколько направлений: подготовка право устанавливающих документов, подготовка технической документации; сбор справок о регистрации лиц на жилой площади; об отсутствии задолженностей по коммунальным платежам; и другие необходимые документы (справки, удостоверения, дубликаты)
						<ul>
		...
		<div class="row">
			<div class="col-lg col-md">
				<div class="offer offer__second-block">
					...
					<div class="offer__main">----- по продаже объекта недвижимости ----- по приобретению объекта недвижимости ---- с поиском объекта недвижимости (справки, удостоверения, дубликаты)
						<div class="offer__price-labe offer__price-label_small">стоимость: <br>
			...
			<div class="col-lg col-md">
				<div class="offer offer__third-block">
					...
					<div class="offer__main"> ---- по комплектности документов для совершения сделки. ----- по вопросам ценообразования ----- по заключению договора, задатка, аванса, предварительного договора и пр. ---- по возможностям ипотечного кредитования
						<div class="offer__price-labe offer__price-label_small">стоимость: <br>
							<span>от 15 500 РУБ </span>
						</div>
					</div>
